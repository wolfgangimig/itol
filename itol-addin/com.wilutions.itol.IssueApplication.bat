pushd "D:\git\itol\itol-addin"
set CP=D:\git\itol\itol-addin\bin
...
set CP=%CP%;C:\Users\Wolfgang\.gradle\caches\modules-2\files-2.1\org.controlsfx\controlsfx\8.40.10\fe12544570095b334d45c61e8c9a26f30ffc1675\controlsfx-8.40.10.jar
...
"C:\Program Files (x86)\Java\jdk1.8.0_65\jre\bin\javaw.exe" -classpath "%CP%" com.wilutions.itol.IssueApplication
