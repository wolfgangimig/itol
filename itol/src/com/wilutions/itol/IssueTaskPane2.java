...
public class IssueTaskPane2 extends TaskPaneFX implements Initializable {
	...
	public IssueTaskPane2(MailInspector mailInspectorOrNull, IssueMailItem mailItem) {
...
//			bnSelection.setGraphic(new ImageView(imgFlag));
	...
	private class IssueCreatedPane extends DlgIssueCreated {
		...
		protected void onClosePanel() {
			IssueTaskPane2.this.setVisible(false);
			vboxRoot.getChildren().clear();
			vboxRoot.getChildren().add(rootGrid);
		}
