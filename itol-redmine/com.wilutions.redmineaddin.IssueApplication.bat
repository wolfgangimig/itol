pushd "D:\git\itol\itol-redmine"
set CP=D:\git\itol\itol-redmine\bin
...
set CP=%CP%;D:\git\itol\itol-addin\lib\joa.jar
set CP=%CP%;D:\git\itol\itol-db\bin
"C:\Program Files (x86)\Java\jdk1.8.0_71\jre\bin\java.exe" -classpath "%CP%" com.wilutions.redmineaddin.IssueApplication
